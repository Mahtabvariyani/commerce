...
import { CartProdutType } from "@prisma/client";
...
const OrderItem: React.FC<OrderItemProps> = ({ item }) => {
  return (
    <div className="grid grid-cols-5 text-xs md:text-sm gap-4 border-t-[1.5px] border-slate-400 py-4 items-center">
      ...
      <div className="justify-self-center">{formatData(item.price)}</div>
      <div className="justify-self-center">{item.quaantity}</div>
