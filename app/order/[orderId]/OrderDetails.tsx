...
const OrderDetails: React.FC<OrderDetailsProps> = ({ order }) => {
  return (
    <div className="max-w-[1150px] m-auto flex flex-col gap-2">
      ...
      <div>
        Total Amount:
        <span className="font-bold">{formatData(order.amount)}</span>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-5 text-xs gap-4 pb-2 items-center">
          <div className="col-span justify-self-start">PRODUCT</div>
          <div className=" justify-self-start-center">PRICE</div>
